...
<div class="m-4 p-3 width-medium">
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        ...
        <form action="/app/trainings/edit" method="get">
            ...
            <div class="schedules-content">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" value="${training.trainingDay}" id="trainingDate" type="date"
                               name="date">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                                <textarea class="form-control" rows="5" id="trainingDescription"
                                          value="<c:out value='${training.description}'/>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" value="${trainingDetail.kilometers}" id="trainingDistance"
                               type="number" name="kilometers">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" value="${minutes}" id="trainingMinutes" type="number"
                               name="minutes">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" value="${seconds}" id="trainingSeconds" type="number"
                               name="seconds">
                    </div>
                </div>
                <div class="col noPadding">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" value="${trainingDetail.height}" id="height" type="number"
                               name="height">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" value="${trainingDetail.weight}" id="weight" type="number"
                               name="weight">
                    </div>
                </div>
            </div>
