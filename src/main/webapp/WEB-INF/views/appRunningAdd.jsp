...
<div class="m-4 p-3 width-medium">
    <div class="dashboard-content border-dashed p-3 m-4 view-height">
        ...
        <form action="/app/trainings/add" method="get">
            <div class="row border-bottom border-3 p-1 m-1">
                <div class="col noPadding">
                    <h3 class="color-header text-uppercase">Add your new training</h3>
                </div>
            ...
            <div class="schedules-content">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" id="trainingDate" type="date" name="date">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                                <textarea class="form-control" rows="5" id="trainingDescription"
                                          placeholder="training description" name="description"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" id="trainingDistance" type="number" name="kilometers">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" id="trainingHours" type="number" name="hours">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" id="trainingMinutes" type="number" name="minutes">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" id="trainingSeconds" type="number" name="seconds">
                    </div>
                </div>
                <div class="col noPadding">
